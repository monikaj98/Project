    ...
    <div className='login card'>
     <div>
        <form method="post"  name="userRegistrationForm"  onSubmit= {this.submituserRegistrationForm} >
            <span className="label" id="regi1"> Enter your Username: </span>
            <input type="text" name="username" value={this.state.fields.username} onChange={this.handleChange} />
            <div className="errorMsg">{this.state.errors.username}</div>
            <span className="label" id="regi1"> Enter your E-mail: </span>
            <input type="text" name="emailid" value={this.state.fields.emailid} onChange={this.handleChange}  />
            <div className="errorMsg">{this.state.errors.emailid}</div>
            <span className="label" id="regi1"> Enter your Mobile No: </span>
            <input type="text" name="mobileno" value={this.state.fields.mobileno} onChange={this.handleChange}   />
            <div className="errorMsg">{this.state.errors.mobileno}</div>
            <span className="label" id="regi1"> Set your Password: </span>
            <input type="password" name="password" value={this.state.fields.password} onChange={this.handleChange} />
            <div className="errorMsg">{this.state.errors.password}</div>
            <button className="reg" id="regi2"> Register </button> <br /> <br />
            <Link to='/Login'><span className="foot" id="regi"> Already have an account? Login here </span></Link>
        </form>
    </div>
</div>
