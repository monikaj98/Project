...
class Potraits extends React.Component {
    ...
    render() {
        return (
            ...
            <Navbar2 />
            <div className="card4">
            <h1 className='heading'>Portraits<img src="https://imgur.com/fq1onLQ.jpg" id="tppo"/></h1>
            <div className='row'>
                <div className='col m6'>
                    <div className="detail3">
                        <img src="https://imgur.com/5SbEseN.jpg" alt="not available" id="trp"/>
                    </div>
                </div>
                <div className='col m6'>
            ...
            <div className='row'>
                    <div className='col s3'>
                        <img className='image1 im2' src='https://imgur.com/pX0sdpa.jpg' id="tp" alt='pic1' />
                    ...
                    <div className='col s3'>
                        <img className='image1 im2' src='https://imgur.com/Ho50zXt.jpg' id="tp" alt='pic1' />
                    ...
                    <div className='col s3'>
                        <img className='image1 im2' src='https://imgur.com/mA5SEjI.jpg' id="tp" alt='pic1' />
                ...
                <div className='row'>
                    <div className='col s3'>
                        <img className='image1 im2' src='https://imgur.com/ozt1XBc.jpg'id="tp" alt='pic1' />
                    ...
                    <div className='col s3'>
                        <img className='image1 im2' src='https://imgur.com/BgbbB16.jpg' id="tp" alt='pic1' />
                    ...
                    <div className='col s3'>
                        <img className='image1 im2' src='https://imgur.com/0RKGwdT.jpg' id="tp" alt='pic1' />
